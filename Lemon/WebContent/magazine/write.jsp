...
<script type="text/javascript"
	src="./assets/js/se2/js/HuskyEZCreator.js" charset="utf-8"></script>
<script>
	...
	<div id="cont_wrap" class="clfix">
		...
		<div id="conts_section" class="pr_none">
			<form action="./magazineBoardWriteAction.maga" method="post" id="frm">
				...
				<p>
				<center>
					<input type="button" id="savebutton" class="button" value="글쓰기"> <input
						type="button" class="button" value="글목록" onclick="">
				</center>
				</p>
			</form>
		</div>
