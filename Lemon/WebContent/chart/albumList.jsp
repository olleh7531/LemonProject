...
<%
	ArrayList albumList = (ArrayList) request.getAttribute("albumList");
...
<body>
	...
	<div id="cont_wrap" class="clfix">
		<div
			...
			<div class="div_tab">
				<ul class="tab">
					<li data-tab="tab1"><a href="./LemonLatest_Chart.ct">최신곡</a></li>
					<li class="current" data-tab="tab2"><a
						href="./LemonAlbumList.ct" class="cur_menu mlog"><span
							class="menu_bg menu01">최신 앨범</span></a></li>
								...
								<%
									if (count != 0) {
										for (int i = 0; i < albumList.size(); i++) {
											ChartBean cb = (ChartBean) albumList.get(i);
								%>
